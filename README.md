...
- Due to the absence of the SDMMC (SDIO Host) protocol, the SD Card is routed via the Fast SPI interface, to avoid GPIO matrix delays and possibly allow up to 40MHz clock, providing faster write speeds.
